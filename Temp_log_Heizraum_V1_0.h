...
#include <OneWire.h>
//OneWire  ds(2);
#define SENSOR_PIN 2           //////// choose a pin you want to use
...
// Assign the addresses of your 1-Wire temp sensors.
    ...
    DeviceAddress Probe01 = { 0x28,0xFF,0x18,0x59,0xB3,0x16,0x04,0x3E }; 
    DeviceAddress Probe02 = { 0x28,0xFF,0x92,0x16,0x72,0x16,0x03,0x49 };
    DeviceAddress Probe03 = { 0x28,0xFF,0x47,0xF2,0xB2,0x16,0x05,0x0C };
...
const char* ssid = "************";
const char* password = "****************";
const char* mqtt_server = "192.***.***.**";     /// MQTT  Broker
